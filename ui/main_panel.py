...
class MaterialCombinerPanel(bpy.types.Panel):
    ...
    def _add_gap_settings(
        ...
        self._create_property_row(
            gap_col, "smc_diffuse_size", "Base Color Size:"
        )

        self._create_property_row(
            gap_col, "smc_gaps", "Spacing Between Textures:"
        )

    @staticmethod
    def _create_property_row(
        layout: bpy.types.UILayout, prop: str, label: str
    ) -> None:
